...
<body>
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="text-primary">Club Overall Reports</h1>
                ...
                <tbody id="weeklyRecordTbody">
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="view_club.php?record_id=<?= $row['id'] ?>" class="btn btn-sm btn-info">View</a>
            ...
            $('.delete-btn').click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'delete_club.php?record_id=' + recordId;
                    }
                });
            });
        });
    ...
    <div class="d-flex justify-content-center my-3">
        <a href="/excel_sheets/dashboad.php" class="btn btn-secondary">Back to Dashboard</a>
    </div>
</body>
</html>